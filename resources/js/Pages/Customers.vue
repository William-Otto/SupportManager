        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                    ...
                    <button @click="openModal()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-3">Novo cliente</button>
                    <table class="table-fixed w-full">
                        <thead>
                            <tr class="bg-gray-100">
                                <th class="px-4 py-2 w-20">ID</th>
                                <th class="px-4 py-2">Nome</th>
                                <th class="px-4 py-2">Código Cidade</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr v-for="row in data" :key="row">
                                ...
                                <td class="border px-4 py-2">{{ row.city_id }}</td>
    ...
    export default {
        ...
        methods: {
            ...
            deleteRow: function (data) {
                if (!confirm('Você tem certeza que quer deletar?')) return;
                data._method = 'DELETE';
                this.$inertia.post('/customers/' + data.id, data)
                this.reset();
                this.closeModal();
